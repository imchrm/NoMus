...
4.  `->` **User** (видит предложение принять условия)
   ...
   > **Примечание:** Если пользователь игнорирует кнопку "Принять условия", он не получает доступа к главному меню. Любой текстовый ввод может быть либо проигнорирован, либо обработан глобальными командами (например, `/start` начнет процесс заново).
